 ...
 * @since 2024-04-17
 */
public class ActualizarTrabajadorOperativo extends javax.swing.JDialog
{
    /**
     * Creates new form AgregarMedicamento
     */
    public ActualizarTrabajadorOperativo(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ACTUALIZAR TRABAJADOR OPERATIVO");
